...
// $result - указатель на переменную, в котороую запишим окончательный вариант "плана" закупки
// $minPrice - указатель на переменную для поиска плана с минимальной стоимостью
