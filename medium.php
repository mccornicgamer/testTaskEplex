...
// сюда сохраним найденные "планы" закупок,
// элемент имеет форматв формате [[id1 => [amount11, price1]], [id2 => amount22, price2] ...]
$result = [];
$minPrice = null;

// будем использовать рекурсию для поиска вариантов,
// эта функция обхода прайса и сбора "планов" для закупок, без учета общей стоимости
//
...
// $result - сюда запиши окончатеьные варианты "палнов" закупок
...
// Найдем все комбинации возможных "планов"
